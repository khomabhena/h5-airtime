...
import { getAllCountries } from '../../src/data/carriers';
...
const PhoneInputV2 = ({ phoneData, setPhoneData, topUpType, setTopUpType }) => {
  ...
  const handleContinue = () => {
    if (validation.isValid && validation.carrier && validation.isComplete) {
      ...
      if (topUpType === 'myself') {
        navigate('/v2/bundles'); // Skip recipient stage
      } else {
        navigate('/v2/recipient'); // Go to recipient stage
      }
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Main Top-up Section - Full Length */}
