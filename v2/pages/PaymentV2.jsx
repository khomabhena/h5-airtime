...
import { processPayment } from '../../src/data/payment';
import { formatCurrency } from '../../src/utils/uiUtils.jsx';
import Button from '../components/ButtonV2';

const PaymentV2 = ({ phoneData, selectedBundle, setPaymentData }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="bg-white shadow-lg border border-gray-100 w-full flex-1 flex flex-col">
          ...
          <div className="bg-white rounded-xl shadow-md p-4 border border-gray-100 mb-6">
            ...
            <div className="space-y-2 text-gray-950">
              ...
              <div className="flex justify-between text-base font-bold">
                <span>Total</span>
                <span style={{color: '#662d91'}}>{formatCurrency(selectedBundle?.price || 0)}</span>
              </div>
            </div>
          </div>
        ...
        {/* Pay Button - Fixed at Bottom Inside Card */}
        <div className="p-6">
          <Button
